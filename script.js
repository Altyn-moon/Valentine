...
const gifs = ["img/sad-1.jpg", "img/sad-2.jpg", "img/sad-3.jpg", "img/sad-5.jpg", "img/sad-4.jpg"];
// array of messages
const buttonMessages = ["Ты уверен??", "Пожалуйста!", "ПОЖАЛУЙСТА!", "Ты не можешь этого делать!", "Точноо?!"];
